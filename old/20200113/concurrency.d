    ...
    ***************************************************************************/
    ...
    public void spawn (void delegate () op, size_t sz = 0)
    {
        auto t = new Thread({
            ...
            //writefln("ThreadScheduler.spawn1");
            thisScheduler = new LocalFiberScheduler();
            //writefln("ThreadScheduler.spawn2");
            op();
        });
        t.start();
...
public class FiberScheduler : Scheduler, InfoObject
{
...
public class LocalFiberScheduler : FiberScheduler
{
    ...
    public this ()
    {
        ...
        {
            writefln("create main thread scheduler");
            this.is_main = true;
        ...
        {
            writefln("create other thread scheduler");
            this.is_main = false;
        }
    }
