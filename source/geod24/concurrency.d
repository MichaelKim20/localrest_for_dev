...
final class LocalScheduler : BaseFiberScheduler
{
    import core.sync.condition;
    import core.sync.mutex;
...
public void createScheduler () @safe nothrow
{
    if (scheduler is null)
    ...
    ***************************************************************************/
    ...
    class MessageBox
    {
        this () @trusted nothrow /* TODO: make @safe after relevant druntime PR gets merged */
        {
            ...
            // This prevents the fiber from being blocked
            // when put and get are used one after another.
            this.qsize = 0;
            this.closed = false;
